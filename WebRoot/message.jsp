    	...
    	<c:choose>
    		...
    		<c:otherwise>
        		...
        		<div style="line-height:60px;margin-top:-15px;">
					...
					<a href="MessageServlet?method=view&curPage=${pageModel.previousPage}">上一页</a>
           		 	<span>
            		...
            		<a href="MessageServlet?method=view&curPage=${pageModel.nextPage}">下一页</a>
        		</div>
    			</div>
    		</c:otherwise>
    	</c:choose>
...
<footer>
    ...
    function changePage(){
		...
		window.open("MessageServlet?method=view&curPage="+curPage,"_self");
	};
	function sea(){
